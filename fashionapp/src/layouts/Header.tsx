  ...
  return (
    <header className="w-full bg-white shadow sticky top-0 z-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1320px] flex items-stretch justify-between h-16">
        ...
        <Drawer className="lg:hidden h-full" title={<span className="text-xl font-bold">Categories</span>} placement="left" open={openMenu} onClose={() => setOpenMenu(false)}>
          <div className="flex flex-col h-full justify-between">
            ...
            <div className="flex flex-col gap-2 px-2 pb-4 border-t border-gray-200">
              <div className="font-bold text-base mt-5 mb-1">NEED HELP?</div>

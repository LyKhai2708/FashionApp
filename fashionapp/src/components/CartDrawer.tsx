...
export default function CartDrawer(props: CartDrawerProps) {
    ...
    return (
        <Drawer
            title={<div className="flex items-center gap-2"><ShoppingCart className="w-5 h-5" /> <span>Cart</span></div>}
            placement="right"
            width={420}
            onClose={onClose}
            open={open}
        >
            {cartItems.length === 0 ? (
                <div className="flex flex-col items-center justify-center text-center py-10">
                    ...
                    <div className="mt-4 text-gray-600">Cart is empty</div>
                </div>
            ) : (
                        ...
                        <div className="flex gap-3" key={item.cart_item_id}>
                            ...
                            <div className="flex-1">
                                ...
                                <div className="mt-2 flex items-center justify-between">
                                    ...
                                    <div className="text-xs text-gray-600">Quantity: <span className="font-medium text-gray-800">{item.quantity}</span></div>
                                </div>
                            </div>
                        </div>
                    ))}
